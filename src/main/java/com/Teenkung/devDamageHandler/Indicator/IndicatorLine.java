...
public class IndicatorLine {
    ...
    public final Boolean skillCrit;        // true if this line represents a skill crit
    ...
    public IndicatorLine(double value, boolean immune, boolean crit, boolean skillCrit,
